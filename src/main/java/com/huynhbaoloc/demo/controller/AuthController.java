...
import com.huynhbaoloc.demo.repository.RoleRepository;
import com.huynhbaoloc.demo.repository.UserRepository;
import com.huynhbaoloc.demo.security.jwt.JwtUtils;
import com.huynhbaoloc.demo.security.service.UserDetailsUImpl;
...
public class AuthController {
	...
	public ResponseEntity<?> authenticateUser(@Valid @RequestBody LoginRequest  loginRequest){
		...
		UserDetailsUImpl userDetails = (UserDetailsUImpl) authentication.getPrincipal();
